...
async function videy(path) {
  try {
    ...
    return `https://cdn.videy.co/${raw?.data?.id}.${mime.ext}`
  } catch (err) {
    throw Error(err.message)
  }
}
